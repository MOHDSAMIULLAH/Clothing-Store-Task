...
const uri =
  "mongodb+srv://samiullah0813:samiullah0813@clothing-store-task.hx85l.mongodb.net/?retryWrites=true&w=majority&appName=Clothing-Store-Task";
mongoose
  .connect(uri)
...
// Endpoint to insert initial data into the database
app.post("/seed", async (req, res) => {
  try {
    ...
    const items = [
      ...
      { name: 'Yellow Raincoat', price: '$59.99', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXMrTxV463h0mpmS2SRQOl33yR-1eFQZKHWg&s' },
      { name: 'Green Cargo Pants', price: '$44.99', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRRJMiMDHJC5RKIJaF0QDe5dN3sbUhyGTIzgg&s' },
    ...
    res.status(200).send("Database seeded with initial data");
  } catch (error) {
